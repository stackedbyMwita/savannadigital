...
import TiltedImage from '@/components/layout/TiltImage'
...
export function Hero() {
  ...
  return (
    <section
      className="relative w-full overflow-hidden flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32 pb-8"
      style={{
    ...
    >
      ...
      {/* Ambient glow blobs */}
      <div className="absolute top-30 -z-10 left-1/4 size-72 bg-blue-600 blur-[300px]" />
      <div className="absolute top-100 -z-10 left-5/7 size-72 bg-purple-600 blur-[300px]" />

      {/* ── Eyebrow pill ────────────────────────────────── */}
      <motion.div
        className="group flex items-center mb-8 gap-2 rounded-full p-1 px-3 mt-12 border bg-white/45"
